...
contract Election {
    ...
    constructor() public {
        ...
        addCandidate("Iftekhar", 27, "Hongshan");
        addCandidate("Sayem", 28, "Wuchang");

        setvoterinfo(12345, "shafayet", "shafayet@gmail.com", 24, "Hankou", "123");
        setvoterinfo(12346, "nabil", "nabil@gmail.com", 25, "Hongshan", "123");
        setvoterinfo(12347, "joy", "joy@gmail.com", 26, "Wuchang", "123");

        setadmininfo("shafayet", "shafayet@gmail.com", "123");
        setadmininfo("chen jingliang", "chenjingliang@gmail.com", "123");
    }
    ...
    function addCandidate(string memory _name, uint256 _age, string memory _city) public {
        ...
        emit setcandidate(candidatesCount, _name,_age,_city, 0);
    }
...
// voter
    ...
    event setcandidate(uint256 id, string name, uint256 _age, string _city, uint256 voteCount);
