...
App = {
  ...
  //   await window.alert("Go to Election Office for Face-biometric Verification.");
  ...
  setvoter: async () => {
    ...
    try {
        // Assuming setvoterinfo returns a promise
        window.alert("Registration successful! Please Go to Election Office for Face-biometric Verification.");
        await App.todoList.setvoterinfo(nid, name, email, age, city, pass, { from: App.account });
        // window.location.reload();
    } catch (error) {
